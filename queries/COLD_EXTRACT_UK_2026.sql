/* EXPORT: FACT_SALES_UK_YTD
   Logic: Historical YTD export for UK with CSV text qualifiers.
*/

-- ==========================================================
-- UNITED KINGDOM (UK - DES) - Invoices & Invoiced Credit Notes
-- ==========================================================
SELECT 
...
-- ==========================================================
-- UNITED KINGDOM (UK - DES) - Standalone Credit Notes
-- ==========================================================
SELECT 
    CHAR(34) + 'UK' + CHAR(34), 
    T0."DocEntry", 
