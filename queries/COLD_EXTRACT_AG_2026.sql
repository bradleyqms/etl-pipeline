/* EXPORT: FACT_SALES_CH_YTD
   Logic: Historical YTD export for Switzerland (QMSCH) with CSV text qualifiers.
   FIX: Resolved "Multi-part identifier could not be bound" by completing the second SELECT block.
*/

-- ==========================================================
-- 1. SWITZERLAND (CH) - Invoices & Invoiced Credit Notes
-- ==========================================================
SELECT 
    CHAR(34) + 'CH' + CHAR(34) AS "Entity", 
    T0."DocEntry", 
    T0."DocNum", 
    T0."DocDate",
...
-- ==========================================================
-- 2. SWITZERLAND (CH) - Standalone Credit Notes
-- ==========================================================
SELECT 
    CHAR(34) + 'CH' + CHAR(34), 
    T0."DocEntry", 
    ...
    T1."SlpCode", 
    T0."UpdateDate"
-- FIX: Re-added the missing FROM and JOIN clauses below
