/* EXPORT: FACT_SALES_GMBH_YTD
   Logic: Historical YTD export for Germany with CSV text qualifiers.
  Adjustment: Net Revenue applies document-level discount percent.
*/

-- ==========================================================
-- GERMANY (GmbH) - Invoices & Invoiced Credit Notes
-- ==========================================================
SELECT 
...
-- ==========================================================
-- GERMANY (GmbH) - Standalone Credit Notes
-- ==========================================================
SELECT 
    CHAR(34) + 'GmbH' + CHAR(34), 
    T0."DocEntry", 
    T0."DocNum", 
    T0."DocDate", 
